...
// Returns the private 'App\Repository\PriceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PriceRepository.php';

return $this->privates['App\Repository\PriceRepository'] = new \App\Repository\PriceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
