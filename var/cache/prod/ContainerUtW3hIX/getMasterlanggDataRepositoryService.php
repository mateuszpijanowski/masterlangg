...
// Returns the private 'App\Repository\MasterlanggDataRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MasterlanggDataRepository.php';

return $this->privates['App\Repository\MasterlanggDataRepository'] = new \App\Repository\MasterlanggDataRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
