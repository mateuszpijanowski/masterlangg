...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\MasterlanggDataRepository' => function () {
    return ($this->privates['App\Repository\MasterlanggDataRepository'] ?? $this->load('getMasterlanggDataRepositoryService.php'));
}, 'App\\Repository\\PriceRepository' => function () {
    return ($this->privates['App\Repository\PriceRepository'] ?? $this->load('getPriceRepositoryService.php'));
